...
1. **Create Git Repositories**:
   ...
   - We use this repo in Our Project
     - [learnerReportCS] (https://github.com/safayavatsal/learnerReportCS.git)
  ...
  template:
    ...
    spec:
      ...
      - name: learner-report-frontend
        image: safayavatsal/learnercs_fe
        resources:
          requests:
...
pipeline {
    ...
    environment {
        ...
        DOCKER_IMAGE_FRONTEND = 'safayavatsal/learnercs_fe'
        DOCKER_IMAGE_BACKEND = 'safayavatsal/learnercs_be'
        DOCKER_TAG = "latest"
        
        GITHUB_URL = 'https://github.com/safayavatsal/Orchestration.git'
        GIT_BRANCH = 'main'
